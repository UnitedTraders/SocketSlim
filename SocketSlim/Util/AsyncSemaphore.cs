...
namespace SocketSlim.Util
{
    public class AsyncSemaphore
    {
        ...
        {
            if (maxCount < initialCount) throw new ArgumentException("maxCount should be greater than initialCount", "maxCount");
            if (maxCount < 1) throw new ArgumentOutOfRangeException("maxCount", "Value should be greater than zero.");
            if (initialCount < 0) throw new ArgumentOutOfRangeException("initialCount", "Value should be greater than or equal to zero.");
